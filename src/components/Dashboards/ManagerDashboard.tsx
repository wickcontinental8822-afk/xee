...
export function ManagerDashboard({ activeView, onViewChange }: ManagerDashboardProps) {
  ...
  const [projectDetailTab, setProjectDetailTab] = useState('project-overview');
  ...
  const filteredProjects = projects.filter(project => {
    ...
    return matchesSearch && matchesFilter && matchesEmployee && matchesPriority && matchesProjectType;
  });
      ...
      <div className="space-y-6">
        ...
        <div className="border-b border-gray-200">
          <nav className="flex space-x-8">
            {[
              { id: 'project-overview', label: 'Project Overview', icon: FileText },
        ...
        {/* Tab Content */}
        <div>
          {projectDetailTab === 'project-overview' && (
